            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <div className="flex flex-wrap items-center gap-3 mb-6">
                <button 
                  ...
                  className={`flex items-center gap-2 px-4 py-2 font-bold text-xs rounded-full border transition-all cursor-pointer ${
                    showSegmentDetails 
                    ...
                    {activeSegment ? (
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                          <div className="bg-white dark:bg-[#F4F0E8] rounded-xl p-3 border border-slate-100 dark:border-[#e7e5e4]">
                            <div className="flex items-center gap-1.5 text-slate-500 text-[9px] font-bold tracking-wider uppercase">
                              <RouteIcon className="w-3.5 h-3.5 text-[#0D5C3A]" /><span>Jarak</span>
                            </div>
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                          <div className="bg-white dark:bg-[#F4F0E8] rounded-xl p-3 border border-slate-100 dark:border-[#e7e5e4]">
                            <div className="flex items-center gap-1.5 text-slate-500 text-[9px] font-bold tracking-wider uppercase">
                              <RouteIcon className="w-3.5 h-3.5 text-[#0D5C3A]" /><span>Total Jarak</span>
                            </div>
                            <div className="mt-1.5 flex items-baseline">
