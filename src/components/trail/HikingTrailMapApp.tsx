...
export const LANDMARKS: LandmarkData[] = [
  { id: 'lm-1', name: 'Wisata Alam Tanggul Asri', elevation: 1682, distance: 0.6, lat: -7.399100, lng: 110.036800 },
  { id: 'lm-2', name: 'Selamat Datang', elevation: 1750, distance: 0.8, lat: -7.398800, lng: 110.038000 },
  { id: 'lm-3', name: 'Cemoro Pitu', elevation: 1900, distance: 1.5, lat: -7.397800, lng: 110.042000 },
  { id: 'lm-4', name: 'Hutan Rimba', elevation: 2085, distance: 2.4, lat: -7.396500, lng: 110.046500 },
  { id: 'lm-5', name: 'Ratan Tengah', elevation: 2479, distance: 3.7, lat: -7.393400, lng: 110.053000 },
  { id: 'lm-6', name: 'Mata Air', elevation: 2598, distance: 4.3, lat: -7.391200, lng: 110.058000, type: 'water', icon: '💧' },
  { id: 'lm-7', name: 'Watu Anak', elevation: 2669, distance: 4.6, lat: -7.390200, lng: 110.060000 },
  { id: 'lm-8', name: 'Sabana II', elevation: 2685, distance: 4.8, lat: -7.389800, lng: 110.061000 },
  { id: 'lm-9', name: 'Watu Edeg', elevation: 2888, distance: 5.4, lat: -7.388100, lng: 110.065200 },
  { id: 'lm-10', name: 'Watu Putih', elevation: 2944, distance: 5.6, lat: -7.387200, lng: 110.067100 },
  { id: 'lm-11', name: 'Watu Lawang', elevation: 3279, distance: 6.1, lat: -7.385200, lng: 110.070200 },
  { id: 'lm-12', name: 'Puncak Bogowonto', elevation: 3271, distance: 6.2, lat: -7.384800, lng: 110.070800 },
];
...
const CHART_DATA = [
  ...
  { km: 0.6, elevation: 1682, name: 'Wisata Tanggul Asri', isCheckpoint: false },
  { km: 0.8, elevation: 1750, name: 'Selamat Datang', isCheckpoint: false },
  { km: 1.0, elevation: 1816, name: 'Pos 1 Sikembang', isCheckpoint: true, icon: '🪧' },
  { km: 1.5, elevation: 1900, name: 'Cemoro Pitu', isCheckpoint: false },
  { km: 2.0, elevation: 1974, name: 'Pos 2 Kayu Bogel', isCheckpoint: true, icon: '🪧' },
  { km: 2.4, elevation: 2085, name: 'Hutan Rimba', isCheckpoint: false },
  { km: 3.0, elevation: 2334, name: 'Pos 3 Watu Talang', isCheckpoint: true, icon: '🪧' },
  { km: 3.7, elevation: 2479, name: 'Ratan Tengah', isCheckpoint: false },
  { km: 4.0, elevation: 2539, name: 'Pos 4 Sabana I', isCheckpoint: true, icon: '🪧' },
  { km: 4.3, elevation: 2598, name: 'Mata Air 💧', isCheckpoint: false, type: 'water' },
  { km: 4.6, elevation: 2669, name: 'Watu Anak', isCheckpoint: false },
  { km: 4.8, elevation: 2685, name: 'Sabana II', isCheckpoint: false },
  { km: 5.0, elevation: 2766, name: 'Pos 5 Camp Area ⛺', isCheckpoint: true, icon: '⛺' },
  { km: 5.4, elevation: 2888, name: 'Watu Edeg', isCheckpoint: false },
  { km: 5.6, elevation: 2944, name: 'Watu Putih', isCheckpoint: false },
  { km: 6.0, elevation: 3057, name: 'Pos 6 Kayu Kuno', isCheckpoint: true, icon: '🪧' },
  { km: 6.1, elevation: 3279, name: 'Watu Lawang', isCheckpoint: false },
  { km: 6.2, elevation: 3271, name: 'Puncak Bogowonto', isCheckpoint: false },
